...
const Home = () => (
  <section className="home bd-grid" id="home">
    <div className="home__data">
      ...
      {/* Buttons */}
      <div className="mt-3">
        <a href="mailto:kanaty0153@gmail.com" className="button">📩 Contact</a>
        <a href="/files/TyKana_Resume.pdf" download className="button button--secondary ms-3">
      ...
      <svg className="home__blob" viewBox="0 0 479 467" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g mask="url(#mask0)">
          ...
          <image 
            ...
            x="50" 
            y="60" 
            href="src/assets/img/profile-removebg-preview.png" 
            alt="Profile" 
